var appCircles = new App({
  ...
  close: function (){
   ...
   overDraw2: function () {
    if(this.cx > canvasWidth-this.cs){
        this.scx = this.cx - canvasWidth; if(this.cy > canvasHeight-this.cs)  {this.scy = this.cy - canvasHeight;} else if (this.cy < 0 +this.cs){this.scy = this.cy + canvasHeight;}else{this.scy = this.cy;}}
    if(this.cy > canvasHeight-this.cs){
        this.scy = this.cy - canvasHeight; if(this.cx > canvasWidth-this.cs)  {this.scx = this.cx - canvasWidth;} else if(this.cx < 0 +this.cs){this.scx = this.cx + canvasWidth;}else{this.scx = this.cx;}}
    ...
    if(this.cy < 0 +this.cs || this.cx < 0 +this.cs || this.cy > canvasHeight-this.cs || this.cx > canvasWidth-this.cs){
        ...
        if(this.scy > this.cs && this.scy < canvasHeight - this.cs){this.cy = this.scy; this.scy = 0;}
    if(this.scx > this.cs && this.scx < canvasWidth - this.cs){this.cx = this.scx; this.scx = 0;}
